              ...
              <div className="proj-card" key={p.title}>
                ...
                <div className="proj-body">
                  ...
                  <div className="proj-foot">
                    <a href="#" className="proj-icon-btn" title="Repo coming soon" aria-label="GitHub repository">
                    ...
                    <a href="#" className="proj-icon-btn" title="Preview coming soon" aria-label="Live preview">
