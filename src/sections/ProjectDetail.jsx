...
export default function ProjectDetail() {
  ...
  return (
    <section className="pd-section">
      <div className="wrap">
        <Link to="/" className="pd-back">← Back to Projects</Link>

        <div className="pd-head">
          <span className={'proj-tag' + (project.tag === 'New' ? ' new' : '')}>{project.tag}</span>
        ...
        <div className="pd-body-grid">
          ...
          <div className="pd-side">
            <a href={GITHUB_PROFILE_URL} target="_blank" rel="noopener noreferrer" className="btn-p pd-github-btn">
            ...
            <Link to={`/projects/${nextProject.slug}`} className="btn-o pd-next-btn">
